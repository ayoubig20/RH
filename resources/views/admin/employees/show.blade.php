                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" ><a href="{{ route('admin.employees.index') }}">Liste employees<i
                                    class="bx bx-group-alt"></i></a>
                        </li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @if ($employee->tasks && $employee->tasks->count() > 0)
                                        ...
                                        <p><strong>To do:</strong> <span class="badge bg-danger">{{ $toDoCount }}</span>
                                        </p>
                                        <p><strong>In progress: </strong><span
                                                class="badge bg-warning text-dark">{{ $inProgressCount }}</span></p>
                                        <p><strong>Done: </strong><span class="badge bg-success">{{ $doneCount }}</span>
                                        </p>
                                    @else

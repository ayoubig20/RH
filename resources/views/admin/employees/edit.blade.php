            ...
            <div class="card border-top border-0 border-4 border-info">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-info">{{ $employee->firstName }} {{ $employee->lastName }} Update</h5>
                    </div>
                    <hr>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="martial_status" name="martialStatus" required>
                                        ...
                                        <option value="Single"
                                            {{ $employee->martialStatus == 'Single' ? 'selected' : '' }}>Single</option>
                                        <option value="Married"
                                            {{ $employee->martialStatus == 'Married' ? 'selected' : '' }}>Married</option>
                                    ...
                                    <select class="form-control" id="department_id" name="department_id" required>
                                        ...
                                        @foreach ($viewData['departments'] as $department)
                                            <option value="{{ $department->getId() }}"
                                                {{ $department->getId() == $department->getName() ? 'selected' : '' }}>

                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="modal fade" id="editDepartment{{ $category->getId() }}" tabindex="-1"
                                            aria-labelledby="editDepartment{{ $category->getId() }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editDepartment{{ $category->getId() }}">
                                                            Edit
                                                            Project Category</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <form action="{{ route('admin.category.update', $category->getId()) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">

            ...
            <div class="card">
                <div class="col-12">
                    <div class="text-center text-bold">
                        <h3 class="page-title"><strong>Jobs List
                            </strong></h3>
                    </div>
                </div>
                <div class="col md">
                                        ...
                                        <td>
                                            <div class="d-flex flex-row">
                                                <button type="button" class="btn btn-outline-success btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#editjob{{ $job->getId() }}">
                                                ...
                                                <div class="modal fade" id="editjob{{ $job->getId() }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="editjob{{ $job->getId() }}">
                                                                    Edit
                                                                    job</h5>
                                                ...
                                                <div class="modal fade" id="deleteDepartement{{ $job->getId() }}"
                                                    tabindex="-1" aria-labelledby="deleteDepartement"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-bs-dismiss="modal">Cancel</button>
                                                                <form
                                                                    action="{{ route('admin.jobs.destroy', $job->getId()) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
